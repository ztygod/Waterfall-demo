<template>
  <div class="card-waterfall-container" ref="containerRef" @scroll="handleScroll">
    <div class="card-waterfall-list" ref="listRef">
      <div
        class="card-waterfall-item"
...
import type { IWaterFallProps, ICardItem, IBookCardPos } from "@/utils/type";
